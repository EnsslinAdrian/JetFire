function Level5() {
    LEVEL = new Level(
        [
            // Background (path, x)
            new Background('img/Backgrounds/08/4_game_background.png', -998),

            new Background('img/Backgrounds/08/4_game_background.png', 1),

            new Background('img/Backgrounds/08/4_game_background.png', 1000),

            new Background('img/Backgrounds/08/4_game_background.png', 1999),

            new Background('img/Backgrounds/08/4_game_background.png', 2998),

            new Background('img/Backgrounds/08/4_game_background.png', 3997),

            new Background('img/Backgrounds/08/4_game_background.png', 4996),

            new Background('img/Backgrounds/08/4_game_background.png', 5995),
        ],
...
function movablePlatformsLevel5() {
...
function movablePlatformsTopButtomLevel5() {
    movablePlatformsTopButtomLevel = {
        movablePlatformsTopButtomLevel: [
            { xStart: 290, xEnd: 450, height: 145, yLimit: 165, time: 3000},      
            { xStart: 690, xEnd: 850, height: 145, yLimit: 165, time: 2000},      
            { xStart: 1090, xEnd: 1250, height: 145, yLimit: 165, time: 1000},      
        ]
    };
}

function movablefallingPlatformsLevel5() {
...
function straightGroundPointsLevel5() {
