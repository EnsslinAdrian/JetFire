function Level6() {
    LEVEL = new Level(
        [
            // Background (path, x)
            new Background('img/Backgrounds/05/1_game_background.png', -998),

            new Background('img/Backgrounds/05/1_game_background.png', 1),

            new Background('img/Backgrounds/05/1_game_background.png', 1000),

            new Background('img/Backgrounds/05/1_game_background.png', 1999),

            new Background('img/Backgrounds/05/1_game_background.png', 2998),

            new Background('img/Backgrounds/05/1_game_background.png', 3997),

            new Background('img/Backgrounds/05/1_game_background.png', 4996),

            new Background('img/Backgrounds/05/1_game_background.png', 5995),
        ],
    ...
    [
        ...
        new Platforms('img/Platform/Terain/1.png', 2180, 100, 0,  500), 
...
function movablePlatformsLevel6() {
...
function movablePlatformsTopButtomLevel6() {
...
function movablefallingPlatformsLevel6() {
...
function straightGroundPointsLevel6() {
